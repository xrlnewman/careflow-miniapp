...
test('CareFlow actions are wired to the real appointment and follow-up client', async()=>{
...
test('Vite proxies the default API path to the local CareFlow service', async()=>{
